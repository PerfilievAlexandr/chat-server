...
//go:generate minimock -i github.com/PerfilievAlexandr/chat-server/internal/test_utils.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
// TxManagerMock implements test_utils.TxManager
type TxManagerMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcReadCommitted          func(ctx context.Context, f db.TxHandler) (err error)
	inspectFuncReadCommitted   func(ctx context.Context, f db.TxHandler)
	afterReadCommittedCounter  uint64
	beforeReadCommittedCounter uint64
	ReadCommittedMock          mTxManagerMockReadCommitted
}

// NewTxManagerMock returns a mock for test_utils.TxManager
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Expect(ctx context.Context, f db.TxHandler) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Inspect(f func(ctx context.Context, f db.TxHandler)) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Set(f func(ctx context.Context, f db.TxHandler) (err error)) *TxManagerMock {
	if mmReadCommitted.defaultExpectation != nil {
...
// Then helper
func (mmReadCommitted *mTxManagerMockReadCommitted) When(ctx context.Context, f db.TxHandler) *TxManagerMockReadCommittedExpectation {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
...
// ReadCommitted implements test_utils.TxManager
func (mmReadCommitted *TxManagerMock) ReadCommitted(ctx context.Context, f db.TxHandler) (err error) {
